sap.ui.define([
	"sap/ui/test/Opa5",
	"evia/nd3v/myapp/MyWorklistApp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("evia.nd3v.myapp.MyWorklistApp.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "evia.nd3v.myapp.MyWorklistApp",
					async: true
				},
				hash: oOptions.hash,
