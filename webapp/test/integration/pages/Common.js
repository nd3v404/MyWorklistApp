sap.ui.define([
	...
	return Opa5.extend("evia.nd3v.myapp.MyWorklistApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["evia/nd3v/myapp/MyWorklistApp/localService/mockserver"], function (mockserver) {
